...
(function (Aufgabe11) {
    ...
    function Konfigurator() {
        ...
        for (let i = 0; i < Aufgabe11.baumdaten.length; i++) {
            ...
            baumarten.id = Aufgabe11.baumdaten[i].element; //ID für späteren Nutzen im Warenkorb
        ...
        for (let i = 0; i < Aufgabe11.lieferoptionen.length; i++) {
            ...
            lieferung.id = Aufgabe11.lieferoptionen[i].element;
    ...
    function CheckBoxKugelnAuslesen(CheckElement, anzahl) {
        for (let i = 0; i < Aufgabe11.kugeldaten.length; i++) {
            if (Aufgabe11.kugeldaten[i].element == CheckElement.id) {
                Warenkorb(CheckElement.id, Aufgabe11.kugeldaten[i].name, Aufgabe11.kugeldaten[i].preis, parseInt(anzahl), CheckElement.checked);
            }
        }
    }
    function CheckBoxKerzenAuslesen(CheckElement, anzahl) {
        for (let i = 0; i < Aufgabe11.kerzendaten.length; i++) {
            if (Aufgabe11.kerzendaten[i].element == CheckElement.id) {
                Warenkorb(CheckElement.id, Aufgabe11.kerzendaten[i].name, Aufgabe11.kerzendaten[i].preis, parseInt(anzahl), CheckElement.checked);
            }
        }
    }
    function AuswahlAuslesen() {
        ...
        if (baumname != "") {
            ZuWarenkorb(Aufgabe11.baumdaten, true, baumname);
        }
        else {
